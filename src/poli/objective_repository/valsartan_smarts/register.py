"""
Implements the Valsartan SMARTS task using the TDC oracles [1].

This task is inherited from the GuacaMol benchmark [2]. We recommend you
...
from poli.objective_repository.valsartan_smarts.information import valsartan_smarts_info


class ValsartanSMARTSBlackBox(TDCBlackBox):
    """
    Valsartan SMARTS black box implementation using the TDC oracles [1].
    ...
    def get_black_box_info() -> BlackBoxInformation:
        return valsartan_smarts_info


class ValsartanSMARTSProblemFactory(AbstractProblemFactory):
    """
    Factory class for creating Valsartan SMARTS problems.
    ...
    def create(
        ...
        valsartan_smarts_problem = Problem(
            black_box=f,
            x0=x0,
        )
