...
from poli.objective_repository.zaleplon_mpo.information import zaleplon_mpo_info
...
class ZaleplonMPOBlackBox(TDCBlackBox):
    ...
    def get_black_box_info() -> BlackBoxInformation:
        return zaleplon_mpo_info


class ZaleplonMPOProblemFactory(AbstractProblemFactory):
    """
