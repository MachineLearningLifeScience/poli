"""
Implements the Scaffold HOP task using the TDC oracles [1].
...
from poli.objective_repository.scaffold_hop.information import scaffold_hop_info


class ScaffoldHopBlackBox(TDCBlackBox):
    """
    A black box that gives access to the "Scaffold Hop" oracle of TDC [1].
    ...
    def get_black_box_info() -> BlackBoxInformation:
        return scaffold_hop_info


class ScaffoldHopProblemFactory(AbstractProblemFactory):
    """
    Factory class for creating Scaffold Hop problems.
    ...
    create:
        Creates an Scaffold Hop problem, containing a black box
    ...
    def create(
        ...
        """
        Creates a Scaffold Hop problem.
