...
class DMSGB1IsolatedLogic(AbstractIsolatedFunction):
    ...
    def __init__(
        ...
        # see [2] for reference:
        # "we investigated the fitness landscape of all variants
        # (204 = 160,000) at four amino acid sites (V39, D40, G41 and V54)
        # in an epistatic region of protein G domain B1"
        self.wt = "VDGV"
