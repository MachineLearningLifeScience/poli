"""
Implements the Thiothixene rediscovery task using the TDC oracles [1].
...
from poli.objective_repository.thiothixene_rediscovery.information import (
    thiothixene_rediscovery_info,
)


class ThiothixeneRediscoveryBlackBox(TDCBlackBox):
    """
    Thiothixene rediscovery black box implementation using the TDC oracles [1].
    ...
    def get_black_box_info() -> BlackBoxInformation:
        return thiothixene_rediscovery_info


class ThiothixeneRediscoveryProblemFactory(AbstractProblemFactory):
    """
    ...
    def create(
        ...
        """
        Creates a Thiothixene rediscovery problem.
        ...
        thiothixene_rediscovery_problem = Problem(
            black_box=f,
            x0=x0,
        )

        return thiothixene_rediscovery_problem
