...
from poli.objective_repository.ranolazine_mpo.information import ranolazine_mpo_info
...
class RanolazineMPOBlackBox(TDCBlackBox):
    ...
    def get_black_box_info() -> BlackBoxInformation:
        return ranolazine_mpo_info


class RanolazineMPOProblemFactory(AbstractProblemFactory):
    """
    ...
    def create(
        ...
        """
        Creates a Ranolazine MPO problem.
        ...
        ranolazine_mpo_problem = Problem(
            black_box=f,
            x0=x0,
        )
