"""
This module implements the DMS TrpB black-box,
...
class DMSTrpBBlackBox(AbstractBlackBox):
    """
    TrpB Black Box implementation.
    ...
    def __init__(
        ...
        """
        Initialize the DMSTrpB Register object.
        ...
        self.inner_function = get_inner_function(
            isolated_function_name="dms_trpb__isolated",
            class_name="DMSTrpBIsolatedLogic",
            module_to_import="poli.objective_repository.dms_trpb.isolated_function",
...
class DMSTrpBProblemFactory(AbstractProblemFactory):
    def create(
        self,
        negative: bool = False,
        experiment_id: str | None = None,
