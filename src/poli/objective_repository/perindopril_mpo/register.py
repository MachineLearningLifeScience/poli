"""
Implements the perindopril MPO task using the TDC oracles [1].
...
class PerindoprilMPOBlackBox(TDCBlackBox):
    """
    The TDC oracle for Perindopril MPO [1].
    ...
    def get_black_box_info() -> BlackBoxInformation:
        return perindopril_mpo_info


class PerindoprilMPOProblemFactory(AbstractProblemFactory):
    """
    Factory class for creating Osimetrinib MPO problems.

    We recommend citing [1, 2] when using this task.
    ...
    create:
        Creates an Perindopril MPO problem, containing a black box
    ...
    def create(
        ...
        """
        Creates a Perindopril MPO problem.
        ...
        perindopril_mpo_problem = Problem(
            black_box=f,
            x0=x0,
        )
