...
from poli.objective_repository.isomer_c7h8n2o2.information import isomer_c7h8n2o2_info
...
class IsomerC7H8N2O2BlackBox(TDCBlackBox):
    ...
    def get_black_box_info() -> BlackBoxInformation:
        return isomer_c7h8n2o2_info


class IsomerC7H8N2O2ProblemFactory(AbstractProblemFactory):
    """
