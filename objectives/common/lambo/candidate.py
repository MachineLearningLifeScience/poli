...
from .foldx import FoldxManager
#from objectives.lambo.fluorescence.sasa import SurfaceArea
from .utils import FoldxMutation
...
class FoldedCandidate:
    def __init__(self, work_dir, wild_pdb_path, mutation_list, tokenizer,
        ...
        self.mutant_surface_area = -float('inf')
